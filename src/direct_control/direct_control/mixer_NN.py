...
class OffboardControl(Node):
    def __init__(self):
        ...
        with open('model_parameters_mixer_success.pkl', 'rb') as file:
    ...
    def main_loop(self):
        ...
        # self.get_logger().info(f'Thrust value: {self.thrust_control}')
        ...
        self.mixer_output, self.mixer_caches = L_model_forward(self.NN_input, self.parameters)
